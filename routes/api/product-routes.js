...
router.post('/', async (req, res) => {
  try {
    const productData = await Product.create({
      ...
      id: req.body.id,                          // {
      product_name: req.body.product_name,      //  product_name: "Basketball",
      price: req.body.price,                    //  price: 200.00,
      stock: req.body.stock,                    //  stock: 3,
      tagIds: req.body.category_id,             //  tagIds: [1, 2, 3, 4]
    });                                         // }
    res.status(200).json(productData);
  } catch (err) {
    console.log(err);
